...
print("=" * 60)
print("HPATCHES SIFT MATCHING")
print("=" * 60)

print("\nImage 1:")
print(f"  Path: {IMAGE1_PATH}")
print(f"  Size: {image1.shape[1]} x {image1.shape[0]}")

print("\nImage 2:")
print(f"  Path: {IMAGE2_PATH}")
print(f"  Size: {image2.shape[1]} x {image2.shape[0]}")
...
cv2.imwrite(
    str(RESULTS_DIR / "task_02_sift_keypoints_image1.png"),
    keypoints_image1
)

cv2.imwrite(
    str(RESULTS_DIR / "task_02_sift_keypoints_image2.png"),
    keypoints_image2
)
...
print(f"Total KNN matches: {len(knn_matches)}")
...
print(f"Ratio-test threshold: {ratio_threshold}")
print(f"Good matches after ratio test: {len(good_matches)}")


# ============================================================
# 7. VISUALIZE GOOD SIFT MATCHES
# ============================================================
...
cv2.imwrite(
    str(RESULTS_DIR / "task_02_sift_good_matches.png"),
    good_match_image
)
...
if len(good_matches) == 0:
    raise RuntimeError("No good SIFT matches found.")
...
# ============================================================
# 9. PROJECT IMAGE-1 POINTS USING GROUND-TRUTH HOMOGRAPHY
# ============================================================

# Convert image-1 points to homogeneous coordinates:
#
# p1 = [x, y, 1]^T
#
# Then:
...
# Compare:
#
# SIFT predicted point in image 2
#
#              VS
#
# Ground-truth predicted point using H_1_2
...
# ============================================================
# 13. VISUALIZE GEOMETRICALLY CORRECT MATCHES
# ============================================================
...
# Draw only ground-truth-consistent matches
...
# Draw only geometrically inconsistent matches
...
print("\n" + "=" * 60)
print("SIFT GEOMETRIC EVALUATION")
print("=" * 60)
...
print(f"Minimum error          : {min_error:.4f} pixels")
print(f"Maximum error          : {max_error:.4f} pixels")
...
print(
    ...
    f"match rate: {inlier_percentage:.2f}%"
)

print("\nError distribution:")
print(f"0 - 1 px     : {range_0_1}")
print(f"1 - 3 px     : {range_1_3}")
print(f"3 - 5 px     : {range_3_5}")
print(f"5 - 10 px    : {range_5_10}")
print(f"> 10 px      : {range_over_10}")


# ============================================================
# 15. SAVE TEXT RESULTS
# ============================================================

results_file = RESULTS_DIR / "task_02_sift_results.txt"

with open(results_file, "w", encoding="utf-8") as file:

    file.write("SIFT MATCHING - HPATCHES v_woman\n")
    file.write("=" * 50 + "\n\n")

    file.write("Dataset\n")
    file.write("-" * 50 + "\n")
    file.write("Sequence: v_woman\n")
    file.write("Image 1: 1.ppm\n")
    file.write("Image 2: 2.ppm\n")
    file.write("Ground truth: H_1_2\n\n")

    file.write("SIFT Features\n")
    file.write("-" * 50 + "\n")
    file.write(
    ...
    file.write("Ground-Truth Evaluation\n")
    file.write("-" * 50 + "\n")
    ...
    file.write(
        f"5 - 10 px: {range_5_10}\n"
    )

    file.write(
        f"> 10 px: {range_over_10}\n"
    )
...
print("  task_02_sift_keypoints_image1.png")
print("  task_02_sift_keypoints_image2.png")
print("  task_02_sift_good_matches.png")
print(
    "  task_02_sift_ground_truth_consistent_matches.png"
)
print("  task_02_sift_geometric_outliers.png")
print("  task_02_sift_results.txt")
